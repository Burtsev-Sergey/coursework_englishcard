...
Устанавливает значение состояния пользователя равным 3 когда бот ожидает введение удаляемого слова.
...
def handle_delete_word(message):
  ...
  bot.send_message(cid, (f'Введите английское слово для удаления из вашего словаря.\n'
                         f'Слово начинается с заглавной буквы'))
...
def handle_add_word(message):
    ...
    bot.send_message(cid, (f'Введите новое английское слово и его перевод через пробел.\n'
                           f'Слова начинаются с заглавных букв'))
...
ожидает действия пользователя - "Дальше", "Добавить слово" или "Удалить слово". """
